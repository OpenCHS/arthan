...
drop view if exists arthan_baseline_indicators_view;
create view arthan_baseline_indicators_view as (
    select i.id                                                                             as "Individual ID",
           concat(i.first_name, ' ', i.last_name)                                           as "Full Name",
           classroom.title                                                                  as "Class Name",
           school.title                                                                     as "School Name",
...
drop view if exists arthan_endline_indicator_view;
create view arthan_endline_indicator_view as (
    select i.id                                                                             as "Individual ID",
           concat(i.first_name, ' ', i.last_name)                                           as "Full Name",
           classroom.title                                                                  as "Class Name",
           school.title                                                                     as "School Name",
